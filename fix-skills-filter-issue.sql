...
DO $$
BEGIN
  RAISE NOTICE '✅ 技能筛选问题修复完成！';
  RAISE NOTICE '🔧 修复内容：';
  RAISE NOTICE '   - 原来：skills_filter IS NULL OR r.skills && skills_filter';
  RAISE NOTICE '   - 修复：skills_filter IS NULL OR cardinality(skills_filter) = 0 OR r.skills && skills_filter';
  RAISE NOTICE '🎯 现在可以正确处理空数组 [] 的情况了';
END $$;
