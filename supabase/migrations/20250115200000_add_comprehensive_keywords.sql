-- 添加全面的公司和学历院校关键词
-- Migration: Add Comprehensive Keywords (Companies & Universities)
...
INSERT INTO keyword_library (keyword, category, weight, aliases) VALUES
-- 顶尖985院校
('清华大学', 'education', 1.5, ARRAY['清华', 'Tsinghua', 'THU', '清华大学']),
('北京大学', 'education', 1.5, ARRAY['北大', 'Peking University', 'PKU', '北京大学']),
('上海交通大学', 'education', 1.4, ARRAY['上海交大', 'SJTU', '交大', '上交']),
('复旦大学', 'education', 1.4, ARRAY['复旦', 'Fudan', '复旦大学']),
('浙江大学', 'education', 1.4, ARRAY['浙大', 'ZJU', '浙江大学']),
('中国科学技术大学', 'education', 1.4, ARRAY['中科大', 'USTC', '中国科大', '科大']),
('南京大学', 'education', 1.4, ARRAY['南大', 'NJU', '南京大学']),
('哈尔滨工业大学', 'education', 1.3, ARRAY['哈工大', 'HIT', '哈尔滨工大']),
('西安交通大学', 'education', 1.3, ARRAY['西安交大', 'XJTU', '西交']),
('北京航空航天大学', 'education', 1.3, ARRAY['北航', 'Beihang', 'BUAA', '北京航空航天']),
('北京邮电大学', 'education', 1.3, ARRAY['北邮', 'BUPT', '北京邮电']),
('华中科技大学', 'education', 1.3, ARRAY['华中科大', 'HUST', '华科']),
('电子科技大学', 'education', 1.3, ARRAY['电子科大', 'UESTC', '成电']),
('武汉大学', 'education', 1.3, ARRAY['武大', 'WHU', '武汉大学']),
('中山大学', 'education', 1.3, ARRAY['中大', 'SYSU', '中山大学']),
