...
-- 删除所有可能的search_candidates_rpc函数重载版本
DROP FUNCTION IF EXISTS search_candidates_rpc(text, text, double precision, integer, text, integer, integer, integer, integer, text[], text, uuid, double precision, double precision) CASCADE;
DROP FUNCTION IF EXISTS search_candidates_rpc(text, text, real, integer, text, integer, integer, integer, integer, text[], text, uuid, real, real) CASCADE;
DROP FUNCTION IF EXISTS search_candidates_rpc(text, text, float, integer, text, integer, integer, integer, integer, text[], text, uuid, float, float) CASCADE;
DROP FUNCTION IF EXISTS search_candidates_rpc(text, text, double precision, integer, text, integer, integer, integer, integer, text[], text, double precision, double precision) CASCADE;

-- 删除所有可能的search_jobs_rpc函数重载版本
DROP FUNCTION IF EXISTS search_jobs_rpc(text, text, double precision, integer, text, integer, integer, integer, integer, text[], text, uuid, double precision, double precision) CASCADE;
DROP FUNCTION IF EXISTS search_jobs_rpc(text, text, real, integer, text, integer, integer, integer, integer, text[], text, uuid, real, real) CASCADE;
DROP FUNCTION IF EXISTS search_jobs_rpc(text, text, float, integer, text, integer, integer, integer, integer, text[], text, uuid, float, float) CASCADE;
DROP FUNCTION IF EXISTS search_jobs_rpc(text, text, double precision, integer, text, integer, integer, integer, integer, text[], text, double precision, double precision) CASCADE;

-- 通用删除：删除所有search_candidates_rpc函数
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- 验证修复
SELECT 'All search functions cleaned up and recreated successfully - user filtering removed' as status; 